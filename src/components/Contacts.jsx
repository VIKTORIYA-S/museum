            ...
            <div className="container contacts__container">
                ...
                <div className="contacts__wrapper">
                    <div className="contacts__info">
                        <h6 className="contacts__title">Palais Royal <br /> Musee du Louvre</h6>
                        <p className="contacts__text">address: 75001 Paris, France</p>
                        <p className="contacts__text contacts__text_link"><a href="tel:+1234567890">phone: +33(0) 1 40 20 50
                                50</a></p>
                        <p className="contacts__text contacts__text_link"><a href="mailto:example@email.com">mail:
                                info@louvre.fr</a></p>
                    </div>
